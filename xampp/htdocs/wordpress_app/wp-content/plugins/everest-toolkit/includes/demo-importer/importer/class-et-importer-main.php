...
/**
 * Class for declaring the importer used in the Everestthemes Demo Importer plugin
 *
 * @package mg
 */

class ET_Importer_Main {
	...
	public function __construct( $importer_options = array(), $logger = null ) {
		...
		$this->importer = new ET_WXR_Importer( $importer_options );
