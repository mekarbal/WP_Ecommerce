...
class ET_Theme_Demo_Influence_Blog_Pro extends ET_Theme_Demo {

	public static function import_files() {

		$server_url = 'https://demo.everestthemes.com/demo-data/influence-blog/pro/';
		...
		$demo_urls  = array(
			array(
				...
				'demo_url'                   => 'https://demo.everestthemes.com/influence-blog/pro-demo-i/',
			),
		);
