...
class ET_Theme_Demo_Arya_Multipurpose extends ET_Theme_Demo {

	public static function import_files() {

		$server_url = 'https://demo.everestthemes.com/demo-data/arya-multipurpose/free/';
		...
		$demo_urls  = array(
			array(
				...
				'demo_url'                   => 'https://demo.everestthemes.com/arya/demo/',
			),
			array(
				...
				'demo_url'                   => 'https://demo.everestthemes.com/arya/demo/business/',
			),
			array(
				...
				'demo_url'                   => 'https://demo.everestthemes.com/arya/demo/agency/',
			),
			array(
				...
				'demo_url'                   => 'https://demo.everestthemes.com/arya/demo/beauty/',
			)
		);
