<?php
/**
 * Grace Mag Pro Theme Info Configurations
 *
 * @package Everest_Toolkit
 */

if( ! function_exists( 'everest_toolkit_grace_mag_pro_config'  ) ) {

	function everest_toolkit_grace_mag_pro_config() {

		$config = array(
			'menu_name' => esc_html__( 'Grace Mag Pro Info', 'everest-toolkit' ),
			'page_name' => esc_html__( 'Grace Mag Pro Info', 'everest-toolkit' ),

			/* translators: theme version */
			'welcome_title' => sprintf( esc_html__( 'Welcome to %s - ', 'everest-toolkit' ), 'Grace Mag Pro' ),
			...
			'quick_links' => array(
				...
				'demo_url' => array(
					...
					'url'  => 'https://demo.everestthemes.com/gracemag/pro-demo-one/',
					),
			...
			'getting_started' => array(
				...
				array(
					...
					'button_link'         => esc_url( admin_url( 'themes.php?page=grace-mag-pro-about&tab=recommended_actions' ) ),
					'is_button'           => true,
					'recommended_actions' => false,
					'is_new_tab'          => false,
				),
...
add_action( 'after_setup_theme', 'everest_toolkit_grace_mag_pro_config' );
