<?php
/**
 * Everest News Lite Theme Info Configurations
 *
 * @package Everest_Toolkit
 */

if( ! function_exists( 'everest_toolkit_everest_news_lite_config'  ) ) {

	function everest_toolkit_everest_news_lite_config() {

		$config = array(
			'menu_name' => esc_html__( 'Everest News Lite Info', 'everest-toolkit' ),
			'page_name' => esc_html__( 'Everest News Lite Info', 'everest-toolkit' ),

			/* translators: theme version */
			'welcome_title' => sprintf( esc_html__( 'Welcome to %s - ', 'everest-toolkit' ), 'Everest News Lite' ),
			...
			'quick_links' => array(
				...
				'theme_url' => array(
					...
					'url'  => 'https://everestthemes.com/themes/everest-news-lite/',
					),
				'demo_url' => array(
					'text' => esc_html__( 'View Demo','everest-toolkit' ),
					'url'  => 'https://demo.everestthemes.com/everestnews/demo/everest-news-lite/',
					),
				'documentation_url' => array(
					'text'   => esc_html__( 'View Documentation','everest-toolkit' ),
					'url'    => 'https://everestthemes.com/doc/everest-news-theme-documentation/',
					),
				'pro_url' => array(
					'text' => esc_html__( 'Upgrade To Pro Theme','everest-toolkit' ),
					'url'  => 'https://everestthemes.com/themes/everest-news-pro/',
					'button' => 'primary',
					),
				),
			...
			'getting_started' => array(
				...
				array(
					...
					'button_link'         => 'https://everestthemes.com/doc/everest-news-theme-documentation/',
					'is_button'           => true,
					'recommended_actions' => false,
					'is_new_tab'          => true,
				),
				...
				array(
					...
					'button_link'  			=> 'https://everestthemes.com/themes/everest-news-pro/',
					'is_button'    			=> true,
					'recommended_actions' 	=> false,
					'is_new_tab'   			=> true,
				),
...
add_action( 'after_setup_theme', 'everest_toolkit_everest_news_lite_config' );
