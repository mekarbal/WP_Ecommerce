<?php
/**
 * Ultra Lite Blog Info Configurations
 *
 * @package Everest_Toolkit
 */

if( ! function_exists( 'everest_toolkit_ultra_lite_blog_config'  ) ) {

	function everest_toolkit_ultra_lite_blog_config() {

		$config = array(
			'menu_name' => esc_html__( 'Ultra Lite Blog Info', 'everest-toolkit' ),
			'page_name' => esc_html__( 'Ultra Lite Blog Info', 'everest-toolkit' ),

			/* translators: theme version */
			'welcome_title' => sprintf( esc_html__( 'Welcome to %s - ', 'everest-toolkit' ), 'Ultra Lite Blog' ),
			...
			'quick_links' => array(
				...
				'theme_url' => array(
					...
					'url'  => 'https://everestthemes.com/themes/ultra-lite-blog/',
					),
				'demo_url' => array(
					'text' => esc_html__( 'View Demo','everest-toolkit' ),
					'url'  => 'https://demo.everestthemes.com/viable/demo/ultra-blog/',
					),
				'documentation_url' => array(
					'text'   => esc_html__( 'View Documentation','everest-toolkit' ),
					'url'    => 'https://everestthemes.com/doc/viable-blog-theme-documentation/',
					),
				'pro_url' => array(
			...
			'getting_started' => array(
				...
				array(
					...
					'button_link'         => 'https://everestthemes.com/doc/viable-blog-theme-documentation/',
					'is_button'           => true,
					'recommended_actions' => false,
					'is_new_tab'          => true,
				),
				array(
					...
					'button_link'         => esc_url( admin_url( 'themes.php?page=ultra-lite-blog-about&tab=recommended_actions' ) ),
					'is_button'           => true,
					'recommended_actions' => false,
					'is_new_tab'          => false,
				),
...
add_action( 'after_setup_theme', 'everest_toolkit_ultra_lite_blog_config' );
