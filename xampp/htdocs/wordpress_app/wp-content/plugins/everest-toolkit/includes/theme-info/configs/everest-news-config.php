<?php
/**
 * Everest News Theme Info Configurations
 *
 * @package Everest_Toolkit
 */

if( ! function_exists( 'everest_toolkit_everest_news_config'  ) ) {

	function everest_toolkit_everest_news_config() {

		$config = array(
			'menu_name' => esc_html__( 'Everest News Info', 'everest-toolkit' ),
			'page_name' => esc_html__( 'Everest News Info', 'everest-toolkit' ),

			/* translators: theme version */
			'welcome_title' => sprintf( esc_html__( 'Welcome to %s - ', 'everest-toolkit' ), 'Everest News' ),
			...
			'quick_links' => array(
				...
				'theme_url' => array(
					...
					'url'  => 'https://everestthemes.com/themes/everest-news/',
					),
				'demo_url' => array(
					'text' => esc_html__( 'View Demo','everest-toolkit' ),
					'url'  => 'https://everestthemes.com/themes/everest-news/#et-item-demos',
					),
...
add_action( 'after_setup_theme', 'everest_toolkit_everest_news_config' );
