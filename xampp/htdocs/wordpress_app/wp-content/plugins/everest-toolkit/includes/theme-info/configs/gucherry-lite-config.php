...
if( ! function_exists( 'everest_toolkit_gucherry_lite_config'  ) ) {

	function everest_toolkit_gucherry_lite_config() {

		$config = array(
			'menu_name' => esc_html__( 'GuCherry Lite Info', 'everest-toolkit' ),
			'page_name' => esc_html__( 'GuCherry Lite Info', 'everest-toolkit' ),

			/* translators: theme version */
			'welcome_title' => sprintf( esc_html__( 'Welcome to %s - ', 'everest-toolkit' ), 'GuCherry Lite' ),
			...
			'quick_links' => array(
				...
				'theme_url' => array(
					...
					'url'  => 'https://everestthemes.com/themes/gucherry-lite-free-wordpress-theme/',
					),
				'demo_url' => array(
					'text' => esc_html__( 'View Demo','everest-toolkit' ),
					'url'  => 'https://demo.everestthemes.com/gucherry/gucherry-lite/',
					),
			...
			'getting_started' => array(
				...
				array(
					...
					'button_link'         => esc_url( admin_url( 'themes.php?page=gucherry-lite-about&tab=recommended_actions' ) ),
					'is_button'           => true,
					'recommended_actions' => false,
					'is_new_tab'          => false,
				),
				...
				array(
					...
					'button_link'  			=> 'https://everestthemes.com/themes/gucherry-blog-pro/',
					'is_button'    			=> true,
					'recommended_actions' 	=> false,
					'is_new_tab'   			=> true,
				),
...
add_action( 'after_setup_theme', 'everest_toolkit_gucherry_lite_config' );
