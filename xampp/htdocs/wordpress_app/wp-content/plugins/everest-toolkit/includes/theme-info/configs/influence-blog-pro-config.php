...
if( ! function_exists( 'everest_toolkit_influence_blog_pro_config'  ) ) {

	function everest_toolkit_influence_blog_pro_config() {

		$config = array(
			'menu_name' => esc_html__( 'Influence Blog Pro Info', 'everest-toolkit' ),
			'page_name' => esc_html__( 'Influence Blog Pro Info', 'everest-toolkit' ),

			/* translators: theme version */
			'welcome_title' => sprintf( esc_html__( 'Welcome to %s - ', 'everest-toolkit' ), 'Influence Blog Pro' ),
			...
			'quick_links' => array(
				...
				'demo_url' => array(
					...
					'url'  => 'https://everestthemes.com/themes/influence-blog/#et-item-demos',
					),
			...
			'getting_started' => array(
				...
				array(
					...
					'button_link'         => esc_url( admin_url( 'themes.php?page=influence-blog-pro-about&tab=recommended_actions' ) ),
					'is_button'           => true,
					'recommended_actions' => false,
					'is_new_tab'          => false,
				),
...
add_action( 'after_setup_theme', 'everest_toolkit_influence_blog_pro_config' );
