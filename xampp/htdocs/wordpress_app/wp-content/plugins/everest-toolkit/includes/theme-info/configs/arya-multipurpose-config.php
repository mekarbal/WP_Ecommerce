<?php
/**
 * Arya Multipurpose Theme Info Configurations
 *
 * @package Everest_Toolkit
 */

if( ! function_exists( 'everest_toolkit_arya_multipurpose_config'  ) ) {

	function everest_toolkit_arya_multipurpose_config() {

		$config = array(
			'menu_name' => esc_html__( 'Arya Multipurpose Info', 'everest-toolkit' ),
			'page_name' => esc_html__( 'Arya Multipurpose Info', 'everest-toolkit' ),

			/* translators: theme version */
			'welcome_title' => sprintf( esc_html__( 'Welcome to %s - ', 'everest-toolkit' ), 'Arya Multipurpose' ),
			...
			'quick_links' => array(
				...
				'theme_url' => array(
					...
					'url'  => 'https://everestthemes.com/themes/arya-multipurpose/',
					),
				'demo_url' => array(
					'text' => esc_html__( 'View Demo','everest-toolkit' ),
					'url'  => 'https://everestthemes.com/themes/arya-multipurpose/#et-item-demos',
					),
				'documentation_url' => array(
					'text'   => esc_html__( 'View Documentation','everest-toolkit' ),
					'url'    => 'https://everestthemes.com/doc/arya-multipurpose-theme-documentation/',
					),
				'pro_url' => array(
					'text' => esc_html__( 'Upgrade To Pro Theme','everest-toolkit' ),
					'url'  => 'https://everestthemes.com/themes/arya-multipurpose-pro/',
					'button' => 'primary',
					),
				),
			...
			'getting_started' => array(
				...
				array(
					'title'               => esc_html__( 'Set Up Front Page', 'everest-toolkit' ),
					'text'                => esc_html__( 'Select template for home page via Pages and set the page as front page.', 'everest-toolkit' ),
					'button_label'        => esc_html__( 'Set Front Page', 'everest-toolkit' ),
				...
				array(
					...
					'button_link'         => 'https://everestthemes.com/doc/arya-multipurpose-theme-documentation/',
					'is_button'           => true,
					'recommended_actions' => false,
					'is_new_tab'          => true,
				),
				...
				array(
					...
					'button_link'  			=> 'https://everestthemes.com/themes/arya-multipurpose-pro/',
					'is_button'    			=> true,
					'recommended_actions' 	=> false,
					'is_new_tab'   			=> true,
				),
...
add_action( 'after_setup_theme', 'everest_toolkit_arya_multipurpose_config' );
